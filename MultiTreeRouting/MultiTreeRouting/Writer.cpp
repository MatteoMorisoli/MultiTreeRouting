...
void Writer::writeStretchStars(SmartStretchMatrix &sm, std::string filePath, const int numTrees){
...
void Writer::writeStretchStarStar(SmartStretchMatrix &sm, std::string filePath, const int numTrees){
